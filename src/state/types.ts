...
export interface HODLInfos {
  userinfo: HODLUserInfo
  userRewardInfo: HODLUserRewardInfo
  networkinfo: HODLNetworkInfo
}

export interface HODLUserInfo {
  isStarted: boolean
  ...
  isValid: boolean
  useAffliate: boolean
  affliateAddress: string
}

export interface HODLUserRewardInfo {
  miningReward: BigNumber
  bonusReward: BigNumber
  totalReward: BigNumber
}

export interface HODLNetworkInfo {
  totalHODLs: BigNumber
  totalHODLsAmount: BigNumber
  totalGoodHODLs: BigNumber
  totalGoodHODLsAmount: BigNumber
  totalCurrentHODLing: BigNumber
  totalCurrentHODLingAmount: BigNumber
  totalMiningReward: BigNumber
  totalBonusReward: BigNumber
}
