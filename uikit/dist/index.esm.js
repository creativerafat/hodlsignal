...
var PriceLink$1 = styled.a(templateObject_1$S || (templateObject_1$S = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd, _b = _a.color, color = _b === void 0 ? "textSubtle" : _b;
    return cakePriceUsd != null ? (React__default.createElement(PriceLink$1, null,
...
var StyledLink = styled(Text)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var templateObject_1$v, templateObject_2$k, templateObject_3$9, templateObject_4$7, templateObject_5$4, templateObject_6$2, templateObject_7$2;
...
var RotatingPancakeIcon = styled(Icon$14)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
styled(Icon)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$s, templateObject_2$i, templateObject_3$7, templateObject_4$5, templateObject_5$2, templateObject_6$1, templateObject_7$1;
...
var templateObject_1$b, templateObject_2$6, templateObject_3$3, templateObject_4$2, templateObject_5$1;
...
var templateObject_1$a, templateObject_2$5, templateObject_3$2, templateObject_4$1, templateObject_5, templateObject_6, templateObject_7;
...
var CakeBalance = function (_a) {
    var cakeBalance = _a.cakeBalance, _b = _a.color, color = _b === void 0 ? "textSubtle" : _b;
    return cakeBalance != null ? (React__default.createElement(PriceLink, null,
        React__default.createElement(Icon$14, { width: "24px", mr: "8px" }),
        React__default.createElement(Text, { color: color, bold: true }, "" + cakeBalance.toFixed(3)))) : (React__default.createElement(Skeleton, { width: 80, height: 24 }));
};
var CakeBalance$1 = React__default.memo(CakeBalance);
var templateObject_1$8;

var MenuItem = function (_a) {
    _a.items; _a.isDark; _a.toggleTheme; var currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, cakeBalance = _a.cakeBalance, cakePriceUsd = _a.cakePriceUsd; _a.buyCakeLabel; var props = __rest(_a, ["items", "isDark", "toggleTheme", "currentLang", "langs", "setLang", "cakeBalance", "cakePriceUsd", "buyCakeLabel"]);
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Box, { mr: "20px" },
                        React__default.createElement(CakeBalance$1, { cakeBalance: cakeBalance, color: darkColors.textSubtle })))))));
};
...
var Menu$1 = function (_a) {
    ...
    return (React__default.createElement(Wrapper, null,
        React__default.createElement(StyledNav, { showMenu: showMenu },
            React__default.createElement(Flex, { style: { marginLeft: '50px' } }, !isMobile && React__default.createElement(MenuItems, { items: links, activeItem: activeItem, activeSubItem: activeSubItem, ml: "24px" })),
            React__default.createElement(Flex, { alignItems: "center" },
                !isMobile && (React__default.createElement(Box, { mr: "12px" },
                    React__default.createElement(CakePrice$1, { cakePriceUsd: cakePriceUsd }))),
                !isMobile && (React__default.createElement(Box, { mr: "12px" },
                    React__default.createElement(CakeBalance$1, { cakeBalance: cakeBalance }))),
        ...
        React__default.createElement(BodyWrapper, { mt: !subLinks ? MENU_HEIGHT + 1 + "px" : "0" },
            React__default.createElement(Inner, { isPushed: false, showMenu: showMenu },
                children,
                React__default.createElement(MenuItem, { items: footerLinks, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakeBalance: cakeBalance, cakePriceUsd: cakePriceUsd, buyCakeLabel: buyCakeLabel, mb: [MOBILE_MENU_HEIGHT + "px", null, "0px"] }))),
...
var ConnectModal = function (_a) {
    ...
    var displayListConfig = sortedConfig.slice(0, displayCount);
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        React__default.createElement(ModalHeader, { background: getThemeValue("colors.background")(theme) },
            React__default.createElement(ModalTitle, null,
        ...
        React__default.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default.createElement(Box, { p: "24px" },
                ...
                React__default.createElement(Button, __assign({ as: "a", href: "https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Install the metamask"))))));
};
