...
var PriceLink$1 = styled__default['default'].a(templateObject_1$S || (templateObject_1$S = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd, _b = _a.color, color = _b === void 0 ? "textSubtle" : _b;
    return cakePriceUsd != null ? (React__default['default'].createElement(PriceLink$1, null,
...
var StyledLink = styled__default['default'](Text)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var RotatingPancakeIcon = styled__default['default'](Icon$14)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
styled__default['default'](Icon)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var CakeBalance = function (_a) {
    ...
    return cakeBalance != null ? (React__default['default'].createElement(PriceLink, null,
        React__default['default'].createElement(Icon$14, { width: "24px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: color, bold: true }, "" + cakeBalance.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var CakeBalance$1 = React__default['default'].memo(CakeBalance);
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Box, { mr: "20px" },
                        React__default['default'].createElement(CakeBalance$1, { cakeBalance: cakeBalance, color: darkColors.textSubtle })))))));
};
...
var Menu$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Flex, { style: { marginLeft: '50px' } }, !isMobile && React__default['default'].createElement(MenuItems, { items: links, activeItem: activeItem, activeSubItem: activeSubItem, ml: "24px" })),
            React__default['default'].createElement(Flex, { alignItems: "center" },
                ...
                !isMobile && (React__default['default'].createElement(Box, { mr: "12px" },
                    React__default['default'].createElement(CakeBalance$1, { cakeBalance: cakeBalance }))),
        ...
        React__default['default'].createElement(BodyWrapper, { mt: !subLinks ? MENU_HEIGHT + 1 + "px" : "0" },
            React__default['default'].createElement(Inner, { isPushed: false, showMenu: showMenu },
                children,
                React__default['default'].createElement(MenuItem, { items: footerLinks, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakeBalance: cakeBalance, cakePriceUsd: cakePriceUsd, buyCakeLabel: buyCakeLabel, mb: [MOBILE_MENU_HEIGHT + "px", null, "0px"] }))),
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(ModalContainer, { minWidth: "320px" },
        React__default['default'].createElement(ModalHeader, { background: getThemeValue("colors.background")(theme) },
            React__default['default'].createElement(ModalTitle, null,
        ...
        React__default['default'].createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default['default'].createElement(Box, { p: "24px" },
                ...
                React__default['default'].createElement(Button, __assign({ as: "a", href: "https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Install the metamask"))))));
};
